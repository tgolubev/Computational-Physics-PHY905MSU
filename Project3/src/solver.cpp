...
{   // 4th order Runge-Kutta solver for a planet cluster / spherical solver
    ...
    // Set up arrays
    //NOTE FOR VISUAL STUDIO COMPILER, TO GET ARRAYS WHICH CAN HAVE DIFFERENT LENGHTS WORK PROPERLY, NEED TO USE DEFINITION WITH A POINTER??
    //AS BELOW??

    //double **k1_x = new double[total_planets][dimension],**k2_x = new double[total_planets][dimension],**k3_x= new double[total_planets][dimension],**k4_x= new double[total_planets][dimension];
    //double **k1_v= new double[total_planets][dimension],**k2_v= new double[total_planets][dimension],**k3_v= new double[total_planets][dimension],**k4_v= new double[total_planets][dimension];

    //below is the original code, but doesn't work
